...
def IODA_exclusion_workflow(input_mzML,ppm_error,narrow_noise_threshold,large_noise_threshold):
    ...
    try:
        bashCommand0 = "wget https://github.com/lfnothias/IODA_MassSpec/raw/master/TOPPAS_Workflow/toppas_Exclusion_workflow.toppas -O TOPPAS_Workflow/toppas_Exclusion_workflow.toppas"
